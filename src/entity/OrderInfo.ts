...
@Index('pk_order_info', ['orderId'], { unique: true })
@Entity('order_info', { schema: 'public' })
export class OrderInfo {
  @Column('character varying', { primary: true, name: 'order_id', length: 36 })
  orderId: string;
  ...
  @Column('date', { name: 'close_time', nullable: true })
